      ...
      <div className="container mx-auto px-6 relative z-10">
        <motion.div initial={{ opacity: 0, y: 30 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.9 }} className="text-center mb-20">
          ...
          <h2 className="text-4xl md:text-6xl font-display font-black uppercase tracking-tight leading-[1.1]">
            <span className="text-transparent bg-clip-text bg-gradient-to-b from-[#e8e0cc] to-[#8a7a5a]">Professional </span>
            <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#D4AF37] via-[#F5C542] to-[#C7913C]">Pack Ranks</span>
          </h2>
            ...
            <table className="w-full text-left min-w-[500px]">
              <thead>
                <tr className="border-b border-[#D4AF37]/20 bg-gradient-to-r from-[#D4AF37]/[0.06] via-[#D4AF37]/[0.1] to-[#D4AF37]/[0.06]">
                  <th className="p-5 text-[10px] font-bold uppercase tracking-[0.3em] text-[#D4AF37]">ID</th>
                  <th className="p-5 text-[10px] font-bold uppercase tracking-[0.3em] text-[#D4AF37]">Rank Name</th>
                  <th className="p-5 text-[10px] font-bold uppercase tracking-[0.3em] text-[#D4AF37]">Package Price</th>
                  <th className="p-5 text-[10px] font-bold uppercase tracking-[0.3em] text-[#D4AF37] text-center">Badge</th>
                </tr>
              </thead>
              <tbody>
                {ranks.map((rank, i) => (
                  <motion.tr key={rank.id} initial={{ opacity: 0, x: -20 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true }} transition={{ delay: i * 0.06, duration: 0.5 }} className="group border-b border-[#D4AF37]/[0.06] hover:bg-[#D4AF37]/[0.04] transition-all duration-300 cursor-default">
                    ...
                    <td className="p-5 text-center">
                      <motion.div whileHover={{ scale: 1.15, rotate: 8 }} transition={{ type: "spring", stiffness: 200 }} className="inline-flex items-center justify-center w-10 h-10 rounded-xl bg-gradient-to-br from-[#D4AF37]/[0.08] to-[#C7913C]/[0.04] border border-[#D4AF37]/15 group-hover:border-[#D4AF37]/60 group-hover:shadow-[0_0_15px_rgba(212,175,55,0.15)] transition-all duration-300">
                        <rank.icon className="w-5 h-5 text-[#D4AF37]/60 group-hover:text-[#F5C542] transition-colors duration-300" />
                      </motion.div>
                    </td>
                  </motion.tr>
                ))}
