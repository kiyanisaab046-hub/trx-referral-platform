          ...
          if (txError) {
            ...
            if (txData) {
              // Redundant daily income calculation removed; dailyIncome is derived via useMemo
                ...
                // Only includes level 1 (directs), no indirects
      ...
      <header className={styles.header}>
        ...
        <div className={styles.profileHeader}>
          <button 
            ...
            style={{ 
              background: 'linear-gradient(135deg, rgba(255, 126, 103, 0.2), rgba(255, 195, 113, 0.2))', 
              borderColor: '#FF7E67', 
              color: '#FF7E67',
              fontWeight: '700' 
            }}
        ...
        <div className={styles.mobileDrawerOverlay} onClick={() => setMobileMenuOpen(false)}>
          <div className={styles.mobileDrawer} onClick={(e) => e.stopPropagation()}>
            <button 
              ...
              onClick={() => { router.push('/dashboard/watch-ads'); setMobileMenuOpen(false); }}
              style={{ color: '#FF7E67', fontWeight: '700' }}
            >
              📺 Watch & Earn Ads
            </button>
