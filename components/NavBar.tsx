    ...
    <>
      ...
      >
        ...
        <Link href="/" className="flex items-center gap-3 flex-shrink-0 group">
          <img src="https://i.postimg.cc/hGhQX5YR/ZMhoi-O-modified.png" alt="Logo" style={{ width: '36px', height: '36px', borderRadius: '50%', objectFit: 'cover', flexShrink: 0, border: '1px solid rgba(255,255,255,0.15)', boxShadow: '0 0 18px rgba(0, 210, 255, 0.25)' }} />
